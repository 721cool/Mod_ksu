return
{
	ACTIONFAIL =
    {
        REPAIR =
        {
            WRONGPIECE = "这明显不对，你确定你知道自己在做什么吗？", --化石骨架拼接错误
        },
        BUILD =
        {
            MOUNTED = "这地方太小了，根本放不下。", --建造失败（骑乘状态）
            HASPET = "我已经有一只宠物了，不需要更多麻烦。", --建造失败（已经有一个宠物了）
        },
        SHAVE =
        {
            AWAKEBEEFALO = "我可不想在它醒着的时候自找麻烦。", --给醒着的牛刮毛
            GENERIC = "这东西我可不想碰。", --刮牛毛失败
            NOBITS = "它已经光秃秃的了，没必要再折腾。", --给没毛的牛刮毛
            REFUSE = "only_used_by_woodie", --暂无注释
        },
        STORE =
        {
            GENERIC = "装满了，真是麻烦。", --存放东西失败
            NOTALLOWED = "这东西不能装进那里，别浪费时间。", --存放东西--不被允许
            INUSE = "我应该等轮到我的时候，真是浪费时间。", --别人正在用箱子
            NOTMASTERCHEF = "烹饪水平还不够，真是麻烦。", --暂无注释
        },
        CONSTRUCT =
        {
            INUSE = "有人抢先了，真是麻烦。", --建筑正在使用
            NOTALLOWED = "不匹配，真是浪费时间。", --建筑不允许使用
            EMPTY = "我需要一些建造材料，真是麻烦。", --建筑空了
            MISMATCH = "计划错误，真是浪费时间。", --升级套件错误（目前用不到）
        },
        RUMMAGE =
        {
            GENERIC = "我不能那么做，真是麻烦。", --打开箱子失败
            INUSE = "他们在垃圾里埋头寻找，真是浪费时间。", --打开箱子 正在使用
            NOTMASTERCHEF = "烹饪水平还不够，真是麻烦。", --暂无注释
        },
        UNLOCK =
        {
            WRONGKEY = "我做不到，真是麻烦。", --暂无注释
        },
        USEKLAUSSACKKEY =
        {
            WRONGKEY = "哎呀！那不对，真是浪费时间。", --使用克劳斯钥匙
            KLAUS = "我有点忙，别来烦我！", --克劳斯
        },
        ACTIVATE =
        {
            LOCKED_GATE = "大门锁上了，真是麻烦。", --远古钥匙
        },
        COOK =
        {
            GENERIC = "我现在做不了饭，真是麻烦。", --做饭失败
            INUSE = "好像我们有一样的想法，真是浪费时间。", --做饭失败-别人在用锅
            TOOFAR = "太远了，真是麻烦。", --做饭失败-太远
        },
        START_CARRAT_RACE =
        {
            NO_RACERS = "我肯定是漏掉了什么东西，真是麻烦。", --暂无注释
        },
        DISMANTLE =
        {
            COOKING = "only_used_by_warly", --暂无注释
            INUSE = "only_used_by_warly", --暂无注释
            NOTEMPTY = "only_used_by_warly", --暂无注释
        },
        FISH_OCEAN =
        {
            TOODEEP = "不是海钓竿，不适合深海海钓，真是麻烦。", --暂无注释
        },
        OCEAN_FISHING_POND =
        {
            WRONGGEAR = "这根钓竿不适合在池塘钓鱼，真是浪费时间。", --暂无注释
        },
        READ =
        {
        ...
        GIVE =
        {
            GENERIC = "那东西没有去那里，真是麻烦。", --给予失败
            DEAD = "也许我该留着这个，真是浪费时间。", --给予 -目标死亡
            SLEEPING = "不省人事，无心牵挂，真是麻烦。", --给予--目标睡觉
            BUSY = "我马上再试试，真是浪费时间。", --给予--目标正忙
            ABIGAILHEART = "这值得一试，虽然有点麻烦。", --给阿比盖尔 救赎之心
            GHOSTHEART = "或许，这不是好主意，真是麻烦。", --给鬼魂 救赎之心
            NOTGEM = "我不会把那东西粘上去的，真是浪费时间。", --给的不是宝石
            WRONGGEM = "这个宝石在这里不起作用，真是麻烦。", --给错了宝石
            NOTSTAFF = "它的形状有些不对，真是浪费时间。", --给月石祭坛的物品不是法杖
            MUSHROOMFARM_NEEDSSHROOM = "一颗蘑菇可能会有更多的用处，真是麻烦。", --蘑菇农场需要蘑菇
            MUSHROOMFARM_NEEDSLOG = "一块活木头可能会有更多的用处，真是麻烦。", --蘑菇农场需要活木
            SLOTFULL = "我们已经把一些东西放在那里了，真是麻烦。", --已经放了材料后，再给雕像桌子再给一个材料
            FOODFULL = "这儿已经有一顿饭了，真是麻烦。", --没调用
            NOTDISH = "它肯定不想吃那个，真是麻烦。", --没调用
            DUPLICATE = "我们已经知道那个了，真是浪费时间。", --给雕像桌子已经学习过的图纸
            NOTSCULPTABLE = "即使是科学也不能把那玩意变成雕像，真是麻烦。", --给陶艺圆盘的东西不对
            NOTATRIUMKEY = "它的形状有些不对，真是麻烦。", --中庭钥匙不对
            CANTSHADOWREVIVE = "它不会复活，真是麻烦。", --中庭仍在CD
            WRONGSHADOWFORM = "组装不对，真是麻烦。", --没调用
            NOMOON = "我需要看到月亮才行，真是麻烦。", --洞穴里建造月石科技
            PIGKINGGAME_MESSY = "我得先清理一下，真是麻烦。", --猪王旁边有建筑，不能开始抢元宝
            PIGKINGGAME_DANGER = "现在这样太危险了，真是麻烦。", --危险，不能开始抢元宝
            PIGKINGGAME_TOOLATE = "现在已经太晚了，真是麻烦。", --不是白天，不能开始抢元宝
        },
        GIVETOPLAYER =
        {
            FULL = "你的口袋太满了，真是麻烦。", --给玩家一个东西 -但是背包满了
            DEAD = "也许我该留着这个，真是麻烦。", --给死亡的玩家一个东西
            SLEEPING = "不省人事，无心牵挂，真是麻烦。", --给睡觉的玩家一个东西
            BUSY = "我马上再试试，真是浪费时间。", --给忙碌的玩家一个东西
        },
        GIVEALLTOPLAYER =
        {
            FULL = "你的口袋太满了，真是麻烦。", --给人一组东西 但是背包满了
            DEAD = "也许我该留着这个，真是麻烦。", --给于死去的玩家一组物品
            SLEEPING = "不省人事了，真是麻烦。", --给于正在睡觉的玩家一组物品
            BUSY = "我马上再试试，真是浪费时间。", --给于正在忙碌的玩家一组物品
        },
        WRITE =
        {
            GENERIC = "我觉得它现在这样挺好，没必要改。", --鞋子失败
            INUSE = "只有能容纳一个涂鸦者的空间，真是麻烦。", --写字 正在使用中
        },
        DRAW =
        {
            NOIMAGE = "如果我面前有这东西，就比较容易了，真是麻烦。", --画图缺乏图像
        },
        CHANGEIN =
        {
            GENERIC = "我现在不想换，真是麻烦。", --换装失败
            BURNING = "现在太危险了，真是麻烦。", --换装失败-着火了
            INUSE = "它一次只能进行一种风格转变，真是麻烦。", --衣橱有人占用
        },
        ATTUNE =
        {
            NOHEALTH = "我感觉不够好，真是麻烦。", --制造肉雕像血量不足
        },
        MOUNT =
        {
            TARGETINCOMBAT = "我还没笨到去惹一头狂牛，真是麻烦。", --骑乘，牛正在战斗
            INUSE = "有人抢先骑上去了，真是麻烦。", --骑乘（牛被占据）
        },
        SADDLE =
        {
            TARGETINCOMBAT = "它生气时决不允许我那样做，真是麻烦。", --给战斗状态的牛上鞍
        },
        TEACH =
        {
            KNOWN = "我已经知道那个了，真是浪费时间。", --学习已经知道的蓝图
            CANTLEARN = "我无法学习那个，真是麻烦。", --学习无法学习的蓝图
            WRONGWORLD = "这地图在这用不了，真是麻烦。", --学习另外一个世界的地图
            MESSAGEBOTTLEMANAGER_NOT_FOUND = "光线太暗，我什么都看不到！", --Likely trying to read messagebottle treasure map in caves		--暂无注释
        },
        WRAPBUNDLE =
        {
            EMPTY = "我需要有东西来打包，真是麻烦。", --打包纸是空的
        },
        PICKUP =
        {
            RESTRICTION = "技能不够熟练，用不了，真是麻烦。", --熔炉模式下捡起错误的武器
            INUSE = "科学告诉我，我该等轮到我，真是浪费时间。", --捡起已经打开的容器
            NOTMINE_YOTC =
            {
                "你可不是我的胡萝卜鼠，真是麻烦。", --暂无注释
                "噢，它咬我！真是麻烦。", --暂无注释
            },
        },
        SLAUGHTER =
        {
            TOOFAR = "它逃走了，真是麻烦。", --屠杀？？ 因为太远而失败
        },
        REPLATE =
        {
            MISMATCH = "它需要另一种碟子，真是麻烦。", --暴食-换盘子换错了 比如用碗换碟子
            SAMEDISH = "我只需要用一个碟子，真是麻烦。", --暴食-换盘子已经换了
        },
        SAIL =
        {
            REPAIR = "它不需要修理，真是麻烦。", --暂无注释
        },
        ROW_FAIL =
        {
            BAD_TIMING0 = "太快了，真是麻烦。", --暂无注释
            BAD_TIMING1 = "时机不对，真是麻烦。", --暂无注释
            BAD_TIMING2 = "别再犯了，真是麻烦。", --暂无注释
        },
        LOWER_SAIL_FAIL =
        {
            "哎呦！真是麻烦。", --暂无注释
        ...
        BATHBOMB =
        {
            GLASSED = "不行，表面都变玻璃了，真是麻烦。", --暂无注释
            ALREADY_BOMBED = "别浪费沐浴球，真是麻烦。", --暂无注释
        },
        GIVE_TACKLESKETCH =
        {
            DUPLICATE = "不对，不对，真是麻烦。", --暂无注释
        },
        COMPARE_WEIGHABLE =
        {
            TOO_SMALL = "这家伙太小了，真是麻烦。", --暂无注释
        },
        BEGIN_QUEST =
        {
	...
	ACTIONFAIL_GENERIC = "这鬼动作谁能做出来。",		--动作失败
	ANNOUNCE_BOAT_LEAK = "水越来越多了。",		--暂无注释
	ANNOUNCE_BOAT_SINK = "我可不想淹死！",		--暂无注释
	...
	ANNOUNCE_BEES = "聒噪的蜜蜂！！！！",		--戴养蜂帽被蜜蜂蛰
	ANNOUNCE_BOOMERANG = "啧...",		--回旋镖
	ANNOUNCE_CHARLIE = "这位女士，你好？",		--查理即将攻击
	ANNOUNCE_CHARLIE_ATTACK = "噢！有东西咬我！",		--被查理攻击
	ANNOUNCE_CHARLIE_MISSED = "only_used_by_winona", --winona specific 		--暂无注释
	ANNOUNCE_COLD = "好冷..",		--过冷
	ANNOUNCE_HOT = "需要...冰.呼，这也太热了",		--过热
	ANNOUNCE_CRAFTING_FAIL = "缺少一些关键成分。",		--没调用
	ANNOUNCE_DEERCLOPS = "听起来是个大麻烦",		--boss来袭
	ANNOUNCE_CAVEIN = "地板要被震塌了",		--要地震了？？？
	...
	ANNOUNCE_SACREDCHEST_YES = "啊哈。",		--远古宝箱物品正确给出蓝图
	ANNOUNCE_SACREDCHEST_NO = "它不喜欢那个。",		--远古宝箱
    ANNOUNCE_DUSK = "现在是放学时间咯",		--进入黄昏
	...
	ANNOUNCE_EAT =
	{
		GENERIC = "还不错",		--吃东西
		PAINFUL = "什么鬼食物。",		--吃怪物肉
		SPOILED = "呸，这是人该吃的吗！",		--吃腐烂食物
		STALE = "我就觉得不应该下口。",		--吃黄色食物
		INVALID = "我不吃那玩意！",		--拒吃
        YUCKY = "我的胃要先逃跑了",		--吃红色食物
    ...
    {
        "气喘...吁吁...",		--搬运雕像、可疑的大理石
        "这种活应该让那些热血笨蛋来...",		--搬运雕像、可疑的大理石
        "抬起来...用你的背...",		--搬运雕像、可疑的大理石
        "这不是...高中生该做的...工作...",		--搬运雕像、可疑的大理石
        "为了...休息！",		--搬运雕像、可疑的大理石
        "这东西...正把我头发弄得一团糟吗？",		--搬运雕像、可疑的大理石
        "哼...！",		--搬运雕像、可疑的大理石
        "气喘...吁吁...",		--搬运雕像、可疑的大理石
        "这是最糟糕的...热身...",		--搬运雕像、可疑的大理石
    },
	...
	ANNOUNCE_HOUNDS = "好像有狗叫",		--猎犬将至
	ANNOUNCE_WORMS = "你感觉到了吗，满地的大虫子",		--蠕虫袭击
	ANNOUNCE_HUNGRY = "我的胃要不行了！",		--饥饿
	...
	ANNOUNCE_KNOCKEDOUT = "糟了，意识有点...",		--被催眠
    ...
    ANNOUNCE_NOMOUNTEDGIFT = "我需要从皮弗娄牛身上下来。",		--骑牛的时候打开礼物
	ANNOUNCE_NODANGERSLEEP = "我很害怕就这样睡死过去！",		--危险，不能睡觉
	ANNOUNCE_NODAYSLEEP = "我是猪吗。",		--白天睡帐篷
	ANNOUNCE_NODAYSLEEP_CAVE = "我还真有点想，但是不合适",		--洞穴里白天睡帐篷
	ANNOUNCE_NOHUNGERSLEEP = "空腹不合适睡觉",		--饿了无法睡觉
	...
	ANNOUNCE_PECKED = "豁，白眼狼吗",		--被小高鸟啄
	ANNOUNCE_QUAKE = "听起来不妙。",		--地震
	ANNOUNCE_RESEARCH = "活到老学到老！",		--没调用
	ANNOUNCE_SHELTER = "这种时候也只能勉强凉快",		--下雨天躲树下
	ANNOUNCE_THORNS = "嘶...",		--玫瑰、仙人掌、荆棘扎手
	ANNOUNCE_BURNT = "啊，烫到我了",		--烧完了
	...
	ANNOUNCE_WORMHOLE = "我能拒绝进入这个怪物肚子吗",		--跳虫洞
	ANNOUNCE_TOWNPORTALTELEPORT = "这就是异世界传送吗。",		--豪华传送
	ANNOUNCE_CANFIX = "\n我觉得我能修好这个！",		--墙壁可以修理
	...
	ANNOUNCE_PETRIFED_TREES = "我刚刚是听到树在尖叫吗？",		--石化树
	ANNOUNCE_KLAUS_ENRAGE = "现在比之前更棘手了",		--克劳斯被激怒（杀死了鹿）
	ANNOUNCE_KLAUS_UNCHAINED = "他好像还有别的形态",		--克劳斯-未上锁的  猜测是死亡准备变身？
	ANNOUNCE_KLAUS_CALLFORHELP = "呼叫帮手吗，你这家伙",		--克劳斯召唤小偷
	...
	ANNOUNCE_IS_FEASTING = "冬日盛会快乐！",		--暂无注释
	...
	BATTLECRY =
	{
		...
		PIG = "猪人猪脑袋",		--战斗 猪人
		PREY = "不要输太快",		--战斗 猎物？？大象？
		SPIDER = "就算是蜘蛛我也没办法谦让",		--战斗 蜘蛛
		SPIDER_WARRIOR = "你死好过我死！",		--战斗 蜘蛛战士
		DEER = "眼瞎心也盲",		--战斗 无眼鹿
	},
	COMBAT_QUIT =
	{
		GENERIC = "什么热血笨蛋",		--攻击目标被卡住，无法攻击
		PIG = "嗯，就这样停手吗",		--退出战斗-猪人
		PREY = "逃跑更是顶级啊",		--退出战斗 猎物？？大象？
		SPIDER = "好吧，我也不打算追究",		-- 退出战斗 蜘蛛
		SPIDER_WARRIOR = "放跑了麻烦的家伙",		--退出战斗 蜘蛛战士
	},
	DESCRIBE =
	{
		MULTIPLAYER_PORTAL = "神秘之门...",		-- 物品名:"绚丽之门"
        MULTIPLAYER_PORTAL_MOONROCK = "这是怎样的路",		-- 物品名:"天体传送门"
        MOONROCKIDOL = "这种糟糕的怪异",		-- 物品名:"月岩雕像" 制造描述:"重要人物。"
		...
		WORM =
		{
		    ...
		    WORM = "又一个麻烦的虫子",		-- 物品名:"洞穴蠕虫"
		},
        WORMLIGHT_PLANT = "我觉得挺安全。",		-- 物品名:"神秘植物"
		MOLE =
		{
			HELD = "挖土高手吗",		-- 物品名:"鼹鼠"->拿在手里
		...
		GREENSTAFF = "分解魔术吗",		-- 物品名:"拆解魔杖" 制造描述:"干净而有效的摧毁。"
		GIFT = "神秘的馈赠",		-- 物品名:"礼物"
        GIFTWRAP = "哈哈哈",		-- 物品名:"礼物包装" 制造描述:"把东西打包起来，好看又可爱！"
        ...
        TOWNPORTAL =
        {
			GENERIC = "流沙下面是外星科技还是魔法",		-- 物品名:"强征传送塔"->默认 制造描述:"用沙子的力量聚集你的朋友们。"
			ACTIVE = "准备好分离。",		-- 物品名:"强征传送塔"->激活了 制造描述:"用沙子的力量聚集你的朋友们。"
		},
        TOWNPORTALTALISMAN = 
        {
			GENERIC = "迷你分离器。",		-- 物品名:"沙之石"->默认
			ACTIVE = "更清醒的人能够行走。",		-- 物品名:"沙之石"->激活了
		},
        ...
        MOONDIAL = 
        {
			GENERIC = "倒映着月亮",		-- 物品名:"月晷"->默认 制造描述:"追踪月相！"
		...
		SKELETONHAT = "它给我带来可怕的想象。",		-- 物品名:"骨头头盔"
		...
		NIGHTMARE_TIMEPIECE =
		{
            ...
            DAWN = "梦魇就要结束了！",		-- 物品名:"铥矿徽章" 制造描述:"跟踪周围魔力水平的流动。"
            NOMAGIC = "这里没有魔法能量。",		-- 物品名:"铥矿徽章" 制造描述:"跟踪周围魔力水平的流动。"
		},
		BISHOP_NIGHTMARE = "渗人的破烂",		-- 物品名:"损坏的发条主教"
		ROOK_NIGHTMARE = "愚笨的大脑袋",		-- 物品名:"损坏的发条战车"
		KNIGHT_NIGHTMARE = "一个瘸子木马",		-- 物品名:"损坏的发条骑士"
		MINOTAUR = "比之前的笨脑袋更笨更大",		-- 物品名:"远古守护者"
		SPIDER_DROPPER = "偷袭者",		-- 物品名:"穴居悬蛛"
		NIGHTMARELIGHT = "我想知道这个东西有什么用。",		-- 物品名:"梦魇灯座"
		NIGHTSTICK = "它带电！",		-- 物品名:"晨星锤" 制造描述:"用于夜间战斗的晨光。"
		GREENGEM = "这之中有某种生命...",		-- 物品名:"绿宝石"
		MULTITOOL_AXE_PICKAXE = "这也算不错的工具",		-- 物品名:"多用斧镐" 制造描述:"加倍实用。"
		ORANGESTAFF = "终于让我的脚放松了",		-- 物品名:"懒人魔杖" 制造描述:"适合那些不喜欢走路的人。"
		YELLOWAMULET = "手感温暖。",		-- 物品名:"魔光护符" 制造描述:"从天堂汲取力量。"
		GREENAMULET = "可以考虑建房子了",		-- 物品名:"建造护符" 制造描述:"用更少的材料合成物品！"
		SLURPERPELT = "死了的样子也没什么不同。",			-- 物品名:"铥矿徽章"->啜食者皮 制造描述:"跟踪周围魔力水平的流动。"
		SLURPER = "宁愿死也不不想被它咬",		-- 物品名:"啜食者"
		SLURPER_PELT = "死了的样子也没什么不同。",		-- 物品名:"啜食者皮"
		ARMORSLURPER = "这种东西可太适合我了",		-- 物品名:"饥饿腰带" 制造描述:"保持肚子不饿。"
		ORANGEAMULET = "啊哦，很适合诶",		-- 物品名:"懒人护符" 制造描述:"适合那些不喜欢捡东西的人。"
		YELLOWSTAFF = "这也算魔法，吗",		-- 物品名:"唤星者魔杖" 制造描述:"召唤一个小星星。"
		YELLOWGEM = "这个宝石是黄色的。",		-- 物品名:"黄宝石"
		ORANGEGEM = "一颗橙色宝石，传送吗",		-- 物品名:"橙宝石"
        OPALSTAFF = "不知为何，我有些心悸",		-- 物品名:"唤月者魔杖"
        OPALPRECIOUSGEM = "这个宝石看起来很特别，格外的让我觉得惊人",		-- 物品名:"彩虹宝石"
        TELEBASE = 
		{
        ...
        MUSHROOM_LIGHT2 =
        {
            ON = "蓝色明显是最科学的颜色。",		-- 物品名:"炽菇灯"->开启 制造描述:"受到火山岩浆灯饰学问的激发。"
            OFF = "我们可以用一些主要颜色来生成一个主要光源。",		-- 物品名:"炽菇灯"->关闭 制造描述:"受到火山岩浆灯饰学问的激发。"
            BURNT = "我没有让它发霉，我发誓。",		-- 物品名:"炽菇灯"->烧焦的 制造描述:"受到火山岩浆灯饰学问的激发。"
        },
        MUSHROOM_LIGHT =
        {
        ...
        SLURTLE_SHELLPIECES = "拼不好的拼图。",		-- 物品名:"贝壳碎片"
        SLURTLEHAT = "那会弄乱我的头发。",		-- 物品名:"贝壳头盔"
        ...
        TURF_FOREST = "一块地皮。",		-- 物品名:"森林地皮"
        TURF_GRASS = "一块地皮。",		-- 物品名:"长草地皮"
        TURF_MARSH = "一块地皮。",		-- 物品名:"沼泽地皮" 制造描述:"沼泽在哪，家就在哪！"
        TURF_METEOR = "一块月球地面。",		-- 物品名:"月球环形山地皮" 制造描述:"月球表面的月坑。"
        TURF_PEBBLEBEACH = "一块海滩。",		-- 物品名:"岩石海滩地皮"
        TURF_ROAD = "草草铺砌的石头。",		-- 物品名:"卵石路" 制造描述:"修建你自己的道路，通往任何地方。"
        TURF_ROCKY = "一块地皮。",		-- 物品名:"岩石地皮"
        TURF_SAVANNA = "一块地皮。",		-- 物品名:"热带草原地皮"
        TURF_WOODFLOOR = "这些是木地板。",		-- 物品名:"木地板" 制造描述:"优质复合地板。"
		TURF_CAVE="又一种地皮类型。",		-- 物品名:"鸟粪地皮"
		TURF_FUNGUS="又一种地皮类型。",		-- 物品名:"菌类地皮"
		TURF_SINKHOLE="又一种地皮类型。",		-- 物品名:"黏滑地皮"
		TURF_UNDERROCK="又一种地皮类型。",		-- 物品名:"洞穴岩石地皮"
		TURF_MUD="又一种地皮类型。",		-- 物品名:"泥泞地皮"
		TURF_DECIDUOUS = "又一种地皮类型。",		-- 物品名:"桦树地皮"
		TURF_SANDY = "又一种地皮类型。",		-- 物品名:"兔屋" 制造描述:"可容纳一只巨大的兔子及其所有物品。"
		TURF_BADLANDS = "又一种地皮类型。",		-- 物品名:"兔屋" 制造描述:"可容纳一只巨大的兔子及其所有物品。"
		TURF_DESERTDIRT = "一块地皮。",		-- 物品名:"沙漠地皮"
		TURF_FUNGUS_GREEN = "一块地皮。",		-- 物品名:"菌类地皮"
		TURF_FUNGUS_RED = "一块地皮。",		-- 物品名:"菌类地皮"
		TURF_DRAGONFLY = "你想证明它能防火吗？",		-- 物品名:"龙鳞地板" 制造描述:"消除火灾蔓延速度。"
		POWCAKE = "科学啊，帮帮我们吧。",		-- 物品名:"芝士蛋糕"
        CAVE_ENTRANCE = "我在想那岩石能不能移开。",		-- 物品名:"堵住的陷洞"
        CAVE_ENTRANCE_RUINS = "它有可能在隐瞒什么事情。",		-- 物品名:"被堵住的陷洞"->单机 洞二入口
       	CAVE_ENTRANCE_OPEN = 
        {
            GENERIC = "大地本身在排斥我！",		-- 物品名:"陷洞"->默认
            OPEN = "我敢打赌在那下面肯定能发现各种各样的东西。",		-- 物品名:"陷洞"->打开
		...
		WATERMELON_SEEDS = "西瓜种子。",		-- 物品名:"西瓜种子"
		CAVE_FERN = "它是一种蕨类植物。",		-- 物品名:"蕨类植物"
		CHARCOAL = "又小又黑，闻起来像烧焦的木头。",		-- 物品名:"木炭"
        CHESSPIECE_PAWN = "我有同感。",		-- 物品名:"卒子棋子"
        CHESSPIECE_ROOK =
        {
        ...
        {
            "呃。这太逼真了。",		-- 物品名:"麋鹿鹅棋子" 制造描述:未找到
        },
        CHESSPIECE_DRAGONFLY = "啊，这让我想起一些事情。不好的记忆。",		-- 物品名:"龙蝇棋子"
        CHESSPIECE_BUTTERFLY = "看着挺美的，对吧？",		-- 物品名:"月蛾棋子"
        CHESSPIECE_ANCHOR = "果然和看上去一样沉。",		-- 物品名:"锚棋子"
        CHESSPIECE_MOON = "最近我感到备受启发",		-- 物品名:"“月亮” 棋子"
        CHESSPIECE_CARRAT = "有人胜出了！",		-- 物品名:"胡萝卜鼠雕像"
        CHESSPIECE_MALBATROSS = "它不追着杀你的时候还是挺可爱的。",		-- 物品名:"邪天翁棋子"
        CHESSPIECE_CRABKING = "看着不如麦斯威尔脾气大。",		-- 物品名:"帝王蟹棋子"
		...
		CRITTER_LUNARMOTHLING = "留着她是因为她擅长母亲学。",		-- 物品名:"小蛾子"
		CROW =
		{
			GENERIC = "真可怕！",		-- 物品名:"乌鸦"->默认
			HELD = "它在那里不太快乐。",		-- 物品名:"乌鸦"->拿在手里
		},
		CUTGRASS = "割下来的草，可用于制作和合成其他东西。",		-- 物品名:"草"
		...
		FEATHER_CANARY = "金丝雀的羽毛。",		-- 物品名:"番红花色羽毛"
        ...
        FOSSIL_STALKER =
        {
			...
			FUNNY = "我科学方面的直觉告诉我这有点不对。",		-- 物品名:"化石骨架"->趣味？？
			COMPLETE = "它活着！哦等等，不，它没有。",		-- 物品名:"化石骨架"->准备好了
        },
        ...
        MAXWELLLOCK = "看起来就像一个钥匙孔。",		-- 物品名:"噩梦锁"->单机 麦斯威尔的噩梦锁
        MAXWELLTHRONE = "那个看起来不太舒适。",		-- 物品名:"噩梦王座"->单机 麦斯威尔的噩梦王座
        ...
        MEATRACK =
        {
            ...
            DONE_NOTMEAT = "实验术语里, 我们管它叫 “干的”。",		-- 物品名:"晾肉架" 制造描述:"晾肉的架子。"
        ...
        PURPLEAMULET = "它在向我低语。",		-- 物品名:"噩梦护符" 制造描述:"引起精神错乱。"
		...
		SACRED_CHEST = 
		{
			GENERIC = "我听到窃窃私语了。它想要什么东西。",		-- 物品名:"远古宝箱"->默认
        ...
        YOTC_CARRAT_SCALE = 
        {
            ...
            CARRAT = "它终究只是一个有知觉的蔬菜。",		-- 物品名:"胡萝卜" 制造描述:"灵巧机敏，富含胡萝卜素。"
            CARRAT_GOOD = "胡萝卜鼠熟到可以赛跑了！",		-- 物品名:"胡萝卜鼠秤"
            BURNT = "真是一团糟",		-- 物品名:"胡萝卜鼠秤"->烧焦的
        },                
		BISHOP_CHARGE_HIT = "噢！",		-- 物品名:"胡萝卜鼠秤"->被主教攻击
		...
		UNIMPLEMENTED = "看起来还没有完工！可能有危险。",		-- 物品名:"胡萝卜鼠秤"
		...
		WINTER_ORNAMENTGORGE = "不知道为什么，这让我觉得很饿。",		-- 物品名:"舒缓的装饰"
		...
		PUMPKINPIE = "为了科学，我要全部吃掉。",		-- 物品名:"南瓜饼"
		...
		ACCOMPLISHMENT_SHRINE = "本喵的奖杯！",        		-- 物品名:"奖杯" 制造描述:"证明你作为一个人的价值。"
		LIVINGTREE = "它在观察我吗？",		-- 物品名:"完全正常的树"
		ICESTAFF = "运用冰魔法。",		-- 物品名:"冰魔杖" 制造描述:"把敌人冰冻在原地。"
		REVIVER = "将鬼魂复活。",		-- 物品名:"告密的心" 制造描述:"鬼魂朋友复活了，好可怕。"
        ...
        ATRIUM_RUBBLE = 
        {
			...
			LINE_5 = "能看出这是一座科技发达的宏伟城市。",		-- 物品名:"远古壁画"->第五行
		},
        ...
        MINIFLARE = "我可以点一发，让所有人都知道我在这。",		-- 物品名:"信号" 制造描述:"为你信任的朋友照亮前路。"
		MOON_FISSURE = 
		{
        ...
        CARRAT = 
        {
        	DEAD = "它走到了尽头。",		-- 物品名:"胡萝卜"->死了 制造描述:"灵巧机敏，富含胡萝卜素。"
        	GENERIC = "胡萝卜怎么还长腿了？",		-- 物品名:"胡萝卜"->默认 制造描述:"灵巧机敏，富含胡萝卜素。"
        	HELD = "近看真是丑。",		-- 物品名:"胡萝卜"->拿在手里 制造描述:"灵巧机敏，富含胡萝卜素。"
        	SLEEPING = "有点可爱了。",		-- 物品名:"胡萝卜"->睡着了 制造描述:"灵巧机敏，富含胡萝卜素。"
        },
		BULLKELP_PLANT = 
        {
		...
		TACKLESKETCH = "某种钓具的照片。我打赌我自己就能做……",		-- 物品名:"{item}广告"
		...
		OCEANFISHINGBOBBER_CANARY = "快来跟我的小伙伴问好！",		-- 物品名:"番红花色羽浮标" 制造描述:"深受职业钓手的喜爱。"
		...
		OCEANFISHINGLURE_SPINNER_BLUE = "也许有鱼会上当！",		-- 物品名:"夜飞侠旋转亮片" 制造描述:"适用于夜间垂钓。"
		...
		OCEANFISH_SMALL_6 = "“叶”见为食啊。",		-- 物品名:"比目鱼"
		...
		FISH_BOX = "它们像沙丁鱼一样塞得满满的！",		-- 物品名:"锡鱼桶" 制造描述:"保持鱼与网捕之日一样新鲜。"
        ...
        HERMITHOUSE =
	{
		...
		{
			GENERIC = "调有点低。",		-- 物品名:"中音贝壳钟"->默认
		},
		SINGINGSHELL_OCTAVE4 =
		{
			GENERIC = "这就是大海的声音吗？",		-- 物品名:"低音贝壳钟"->默认
		},
		SINGINGSHELL_OCTAVE5 =
		{
			GENERIC = "它可以唱出高音C了。",		-- 物品名:"高音贝壳钟"->默认
        },
        CHUM = "鱼儿的美味佳肴！",		-- 物品名:"鱼食" 制造描述:"鱼儿的美食。"
        SUNKENCHEST =
        {
            GENERIC = "真正的宝物是我们在寻宝过程中的成长。",		-- 物品名:"沉底箱子"->默认
            LOCKED = "贝壳闭上了！",		-- 物品名:"沉底箱子"->锁住了
        },
		...
		SISTURN =
		{
			GENERIC = "有的花会活泼一些。",		-- 物品名:"姐妹骨灰罐"->默认 制造描述:"让你疲倦的灵魂休息的地方。"
        ...
        MEATRACK_HERMIT =
        {
            ...
            DONE_NOTMEAT = "实验术语里, 我们管它叫 “干的”。",		-- 物品名:"晾肉架"
