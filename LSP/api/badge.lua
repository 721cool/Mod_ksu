...
---@field eventfn fun(badge:widget_badge,owner:ent) # 事件的回调函数,注意事件是客机事件,函数也应是客机,组件请用replica

---@class widget_badge
---@field SetPercent fun(val:number,max:number|nil,penaltypercent:number|nil) # 设置计量表百分比
---@field SetStage fun(stage:integer) # 设置badge相框的样式
