...
---@field fn fun(act: { doer: ent|nil, target: ent|nil, invobject: ent|nil, GetActionPoint: fun(): Vector3}): (boolean|nil) # 动作触发时执行函数
...
---@field testfn fun(inst: ent|any, doer: ent|any, target: ent|any, actions: any, right: any): (boolean|nil) # 检测是否允许触发动作的函数
